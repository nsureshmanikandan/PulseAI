  ...
  const cases = [
    {
      ...
      metrics: [
        { val: '14%', label: 'Default Rate Detected', c: '#ef4444' },
        { val: '$2.1M', label: 'Total Outstanding', c: '#3b82f6' },
        { val: '742', label: 'Avg Credit Score', c: '#10b981' },
      ],
      tag: 'RISK',
      tagColor: '#ef4444',
    },
    {
      ...
      metrics: [
        { val: '23%', label: 'Outlier Claims', c: '#f59e0b' },
        { val: '4.2x', label: 'Fraud Indicators', c: '#ef4444' },
        { val: '8 days', label: 'Avg Processing', c: '#10b981' },
      ],
      tag: 'FRAUD',
      tagColor: '#f59e0b',
    },
    {
      ...
      metrics: [
        { val: '+18%', label: 'Revenue Growth', c: '#10b981' },
        { val: '3', label: 'Underperformers', c: '#ef4444' },
        { val: '92%', label: 'Top SKU Contribution', c: '#8b5cf6' },
      ],
      tag: 'SALES',
      tagColor: '#8b5cf6',
    },
    {
      ...
      metrics: [
        { val: '22%', label: 'Attrition Risk', c: '#ef4444' },
        { val: '6', label: 'Departments Flagged', c: '#f59e0b' },
        { val: '1.4x', label: 'Pay Gap Detected', c: '#8b5cf6' },
      ],
      tag: 'PEOPLE',
      tagColor: '#f59e0b',
    },
